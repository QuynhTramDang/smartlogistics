...
def normalize_addr_text(s: str) -> str:
    if s is None:
        return None
    s = str(s)
    # use unidecode here (driver) to produce ASCII-friendly canonical form
    s = unidecode(s)
    s = s.lower()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--s3_endpoint", type=str, default="http://minio:9000")
    parser.add_argument("--s3_key", type=str, default="minioadmin")
    parser.add_argument("--s3_secret", type=str, default="minioadmin")
    parser.add_argument("--metastore_uri", type=str, default="thrift://delta-metastore:9083")
